 ...
 */
final class Version20210119125756 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE log (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, order_id INT NOT NULL, created_at DATETIME NOT NULL, action LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_8F3F68C5A76ED395 (user_id), INDEX IDX_8F3F68C58D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
