 ...
 */
final class Version20210109210808 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, alias VARCHAR(50) NOT NULL, nip VARCHAR(15) NOT NULL, post_code VARCHAR(6) NOT NULL, city VARCHAR(50) NOT NULL, street VARCHAR(255) NOT NULL, country VARCHAR(2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE log (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, time DATETIME NOT NULL, action LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_8F3F68C5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, author_id INT NOT NULL, staff_id INT NOT NULL, base_lang_id INT NOT NULL, target_lang_id INT NOT NULL, deleted TINYINT(1) NOT NULL, certified TINYINT(1) NOT NULL, pages NUMERIC(10, 2) DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, topic VARCHAR(255) NOT NULL, state VARCHAR(20) NOT NULL, info LONGTEXT NOT NULL, adoption DATETIME NOT NULL, deadline DATETIME NOT NULL, INDEX IDX_F529939819EB6921 (client_id), INDEX IDX_F5299398F675F31B (author_id), INDEX IDX_F5299398D4D57CD (staff_id), INDEX IDX_F52993983F2786C0 (base_lang_id), INDEX IDX_F5299398C04986CF (target_lang_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE staff (id INT AUTO_INCREMENT NOT NULL, fist_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, staff_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, preferences LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), INDEX IDX_8D93D649D4D57CD (staff_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
