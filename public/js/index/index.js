...
//
//         this.currentId = $.query.get("order");
//         this.currentId = this.currentId !== "" ? Number(this.currentId) : null;
//     }
//
//     addTableListeners() {
...
//             let row = tableRows[i];
//             let orderId = row.getAttribute("order-id");
//             if (Number(orderId) === this.currentId) {
...
//                 addEntryForm.addEventListener("submit", c.addEntryExecute.bind(c, addEntryForm), false);
//             }
//         }
//         request.send(data);
//     }
//
//     addEntryExecute(form, e) {
//         e.preventDefault();
//         console.log(form);
//
//         let formData = new FormData(form);
//         formData.append("order", this.currentId);
//         let request = new XMLHttpRequest();
//         let popup = this.centerPopupContent;
//         let c = this;
//
